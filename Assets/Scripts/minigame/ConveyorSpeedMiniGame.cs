...
//     public TextMeshProUGUI speedText;    // 속도 상태 표시
//     public TextMeshProUGUI timerText;    // 성공까지 남은 시간 표시
//     public GameObject uiRoot;            // UI 루트(Canvas나 Panel)

//     [Header("Game Settings")]
//     public float lowSpeed = 1f;          // 낮은 속도
//     public float highSpeed = 2f;         // 높은 속도
//     public float successHoldTime = 5f;   // Low 상태 유지 시간(초)

//     private bool isHighSpeed = true;     // 초기 상태: High
